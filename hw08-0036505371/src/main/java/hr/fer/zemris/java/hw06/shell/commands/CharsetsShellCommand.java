 ...
 * Naredba ne prima niti jedan argument. Detaljniji opis naredbe može se dohvatiti pomoću metode 
...
public class CharsetsShellCommand implements ShellCommand {
	...
	public CharsetsShellCommand() {
		...
		commandDescription.add("Command charsets takes no arguments and lists names of supported charsets for current Java platform.");
