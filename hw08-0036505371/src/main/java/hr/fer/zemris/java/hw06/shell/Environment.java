...
public interface Environment {
	...
	/**
	 * Metoda koja vraća stazu do trenutnog direktorija.
	 * 
	 * @return staza do trenutnog direktorija
	 */
	Path getCurrentDirectory();
	
	/**
	 * Metoda koja postavlja novi trenutni direktorij.
	 * 
	 * @param path novi trenutni direktorij
	 */
	void setCurrentDirectory(Path path);
	
	/**
	 * Metoda za dohvaćanje dijeljenih podataka.
	 * Podaci se čuvaju pod ključem. 
	 * 
	 * @param key ključ podatka
	 * @return dijeljeni podaci
	 */
	Object getSharedData(String key);
	
	/**
	 * Metoda koja omogućava pohranjivanje dijeljenih podataka pod nekim ključem.
	 * 
	 * @param key ključ
	 * @param value vrijednost dijeljenog podatka
	 */
