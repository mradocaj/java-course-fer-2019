...
/**
 * Razred koji modelira naredbu za ispisivanje stabla direktorija.
 * Naredba prima jedan argument - naziv direktorija od kojeg dalje rekurzivno ispisuje sve direktorije i dokumente.
 * 
 * @author Maja Radočaj
 *
 */
public class TreeShellCommand implements ShellCommand {
	...
	public TreeShellCommand() {
		...
		commandDescription.add("It then prints a tree (each directory level shifts output two charatcers "
				+ "to the right).");
	}
	...
	/**
	 * Pomoćna metoda za rekurzivni obilazak direktorija te ispisivanje stabla direktorija.
	 * Svaka nova razina odvojena je sa dva razmaka.
	 * 
	 * @author Maja Radočaj
	 *
	 */
