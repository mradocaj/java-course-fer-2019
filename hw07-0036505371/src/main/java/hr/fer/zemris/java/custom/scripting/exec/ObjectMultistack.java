...
/**
 * Razred koji modelira kolekciju sličnu mapi - postoje ključevi, a svakom
 * ključu je pridodana vrijednost koja predstavlja jedan stog. Za svaki od
 * stogova omogućene su radnje karakteristične za stogove (push, pop, peek).
 * 
 * @author Maja Radočaj
 *
 */
public class ObjectMultistack {
	...
	/**
	 * Privatni razred koji modelira jedan čvor (element na stogu). Svaki čvor ima
	 * vrijednost i referencu na sljedeći čvor.
	 * 
	 * @author Maja Radočaj
	 *
	 */
	...
	/**
	 * Metoda koja skida jedan element sa stoga i vraća njegovu vrijednost. Metoda
	 * se ne smije pozvati nad ključem koji se ne nalazi u kolekciji. Predana
	 * vrijednost ne smije biti <code>null</code>.
	 * 
	 ...
	 * Metoda se ne smije pozvati nad ključem koji se ne nalazi u kolekciji. Predana
	 * vrijednost ne smije biti <code>null</code>.
	 * 
	 * @param keyName ključ stoga
	 * @return vrijednost sa vrha stoga
	...
	/**
	 * Metoda koja provjerava sadrži li kolekcija stog sa nekim
	 * <code>keyName</code>.
	 * 
	 * @param keyName ključ stoga
	...
	/**
	 * Pomoćna metoda koja provjerava je li stog sa ključem <code>keyName</code>
	 * prazan. Ako je, baca se iznimka.
	 * 
	 * @param keyName ključ stoga
