...
/**
 * Razred koji predstavlja subjekt (tj. objekt) u obliku koda zvan Observer
 * pattern. Naš subjekt enkapsulira jednu vrijednost - <code>int</code>
 * vrijednost. Akcije koje treba izvoditi nad subjektom dodaju se u obliku
 * observera.
 * 
 * @author Maja Radočaj
 *
...
public class IntegerStorage {
	...
	/**
	 * Metoda za dodavanje novog observera (slušača promijena) u internu listu. U
	 * slučaju pokušaja dodavanja <code>null</code> vrijednosti, baca se iznimka.
	 * 
	...
	/**
	 * Metoda za uklanjanje observera iz interne iste. U slučaju da se metodi
	 * pošalje <code>null</code> vrijednost, baca se iznimka.
	 * 
	 * @param observer observer kojeg treba ukloniti
	 * @throws NullPointerException ako se pokuša ukloniti <code>null</code>
	 *                              vrijednost
	 */
	...
	/**
	 * Metoda koja pohranjuje novu vrijednost i obaviještava sve observere da se
