...
public interface Collection {
	...
	/**
	 * Metoda koja prima neku kolekciju te dodaje sve njene elemente u našu kolekciju tako da originalna
	 * kolekcija ostane nepromijenjena.
	 * To radi pomoću Processora i metode process koju smo implementirali u lokalnoj klasi.
	 * 
	...
	/**
	 * Metoda koja vraća objekt koji implementira ElementsGetter. 
	 * Taj objekt poslužit će za dohvat elemenata kolekcije.
	 * 
	...
	/**
	 * Metoda dohvaća redom sve elemente iz predane kolekcije col pomoću ElementsGettera, te
	 * u trenutnu kolekciju na kraj dodaje sve elemente koje predani tester prihvati.
	 * 
