...
/**
 * Razred ArrayIndexedCollection modelira kolekciju u obliku niza promjenjive veličine.
 * Svaki objekt ima dvije privatne varijable - size (broj elemenata koji su trenutno u kolekciji) 
 * i niz elemenata elements[].
 * Ova vrsta kolekcije ne smije imati null vrijednosti, ali smiju postojati dvostruki elementi.
 * Ovaj razred implementira metode sučelja Collection te ima neke specijalizirane
...
public class ArrayIndexedCollection implements List {
	...
	/**
	 * Prazni konstruktor, stvara prazno polje elemenata početne dužine 16.
	 * Delegira to stvaranje konstruktoru koji prima int vrijednost kao argument.
	 */
	...
	/**
	 * Konstruktor koji prima int argument - veličinu polja elemenata.
	 * U slučaju da je argument manji od 1, baca se iznimka.
	 * 
	...
	/**
	 * Konstruktor koji prima drugu kolekciju čije elemente kopira i sprema u polje elemenata.
	 * Delegira se drugom konstruktoru koji uz kolekciju prima i veličinu polja.
	 *  
	...
	/**
	 * Konstruktor koji prima drugu kolekciju i veličinu polja.
	 * Ako je umjesto kolekcije dan null pointer, također se baca iznimka (NullPointerException).
	 * U slučaju da je veličina druge kolekcije veća od dane veličine polja, za veličinu polja se uzima 
	 ...
	 * U slučaju da se pokuša dodati null vrijednost, baca se NullPointerException.
	 * Ako se u trenutku pozivanja metode već nalazi maksimalan broj elemenata u polju, vrši se realokacija
	 ...
	 * Metoda prolazi kroz polje te kad prvi put naiđe na instancu traženog objekta ga uklanja i vraća true.
	 * 
	 * @param value element kojeg treba ukloniti
	 * @return true ako se element value nalazi u kolekciji i jednom se ukloni, u svakom drugom slučaju false 
	 */
	@Override
	 ...
	 * Vraćaju se samo ne-null elementi polja (prvih size elemenata).
	 * 
	...
	/**
	 * Metoda koja uklanja sve elemente iz kolekcije (elemente vraća na null, size postavlja na 0).
	...
	/**
	 * Metoda koja vraća objekt koji se u polju nalazi na poziciji index.
	 * Metoda može dohvatiti elemente u rasponu od 0 do size - 1 (granice uključene). 
	 * Ako se pošalje indeks izvan tog raspona, baca se IndexOutOfBoundsException.
	...
	/**
	 * Ubacuje element value na mjesto position u polje. Elementi sa indeksom većim od position se pomiču 
	 * za jedno mjesto udesno.
	 * Pozicija može biti od 0 do size (granice uključive). Ako je position izvan tog raspona, baca se
	...
	/**
	 * Metoda koja vraća indeks na kojem se prvi put pojavljuje objekt value.
	 * Ako se vrijednost ne nalazi u polju, vraća se -1.
	 * Složenost metode je O(n).
	 * 
	...
	/**
	 * Metoda uklanja element sa mjesta index.
	 * Index može biti u rasponu od 0 do size - 1 (uključivo). U suprotnom se baca IndexOutOfBoundsException.
	 * Svi elementi sa indeksom većim od index se pomiču za jedno mjesto ulijevo.
	 * 
	...
	/**
	 * Privatni statički razred koji predstavlja implementaciju sučelja ElementsGettera.
	 * Objekt će vratiti novi element koji još nije vraćen, a ukoliko takvih nema se baca iznimka NoSuchElementException.
	 * 
	 * @author Maja Radočaj
	 *
	 */
	private static class ArrayElementsGetter implements ElementsGetter {
		 ...
		 * Do promjene je došlo ako se pohranjeni broj promjena razlikuje od pravog broja promjena kolekcije.
		 * 
