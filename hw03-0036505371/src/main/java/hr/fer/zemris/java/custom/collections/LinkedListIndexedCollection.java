 ...
 * čvor, kao i svoju vrijednost.
 * <p>
 * Svaki objekt ima privatne varijable size, first i last. First i last su
 * reference na prvi i zadnji čvor u listi. Ova vrsta kolekcije ne smije imati
 * null vrijednosti, ali smiju postojati dvostruki elementi. Ovaj razred
 * implementira metode sučelja Collection te ima neke specijalizirane metode za
 * rad sa dvostruko povezanom listom.
 * 
 * @author Maja Radočaj
 *
 */
