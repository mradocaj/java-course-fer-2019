...
/**
 * Razred koji modelira naredbu za pomoć oko rada sa {@link MyShell}. Naredba
 * prima ili nula ili jedan argument. Detaljniji opis naredbe može se dohvatiti
 * pomoću metode <code>getCommandDescription</code>.
 * 
 * @author Maja Radočaj
 *
 */
public class HelpShellCommand implements ShellCommand {
	...
	public HelpShellCommand() {
		...
		commandDescription.add("If started with no arguments, names of all supported commands "
				+ "will be listed.");
